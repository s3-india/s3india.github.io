...
Vvveb.Builder = {
	...
	initCIMDraw:function(){
		...
		self.documentFrame = $("#iframe-wrapper > svg");
		self.canvas = $("#canvas");
...
Vvveb.Gui = {
	...
	preview : function () {
		...
		$("#right-panel").toggleClass("preview");
	},
...
//layout
	...
	toggleLeftColumn: function () {
		...
		if ($("#left-panel").is(":visible")) {
			console.log("Left Tab Visible");
		} else {
			console.log("Left Tab Hidden");
		}

		riot.store.trigger('resizeGrid')  
	},
	...
	toggleRightColumn: function () {
		...
		if ($("#right-panel").is(":visible")) {
			console.log("Right Tab Visible");
		} else {
			console.log("Right Tab Hidden");
		}
