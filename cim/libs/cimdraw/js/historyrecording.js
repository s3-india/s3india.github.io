...
class HistoryRecordingService {
  ...
  */
   ...
   * @returns {module:history.HistoryRecordingService}
   */
  moveElement (elem, elemOldProp, elemnewProp) {
    if (!this.undoManager_) { return this; }
    this.addCommand_(new MoveElementCommand(this.model_, elem, elemOldProp, elemnewProp));
    return this;
  }
  ...
  insertElement (elem) {
    if (!this.undoManager_) { return this; }
    this.addCommand_(new InsertElementCommand(this.model_, elem));
    return this;
  }
   ...
   * @returns {module:history.HistoryRecordingService}
   */
  removeElement (elem,  oldNextSibling, oldParent) {
    if (!this.undoManager_) { return this; }
    this.addCommand_(new RemoveElementCommand(this.model_, elem,  oldNextSibling, oldParent));
    return this;
  }
  ...
  changeElement (elem, attrs, text) {
    if (!this.undoManager_) { return this; }
    this.addCommand_(new ChangeElementCommand(this.model_, elem, attrs, text));
    return this;
  }
